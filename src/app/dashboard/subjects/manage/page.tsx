...
const initialSubjects: Subject[] = [
  ...
  { id: 'SCR-0167', name: '강도윤', age: 48, gender: '남', site: '세브란스병원', status: '부적격', enrollDate: '2024-01-22', phone: '010-7890-1234', diagnosis: '취장암' },
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: '등록완료', value: stats.enrolled, color: 'text-green-600', bg: 'bg-green-50' },
          { label: '스크리닝 중', value: stats.screening, color: 'text-[#0D9488]', bg: 'bg-teal-50' },
          { label: '철회>������ʤ���م�Ք��х�̹ݥѡ�Ʌݸ�������耝ѕ�еɕ����������耝���ɕ��������(��������t�����̀����(�����������؁�����̹�����􁍱���9���􉉜�ݡ�є�ɽչ����ᰁ͡���ܵʹ���ɑ�ȁ��ɑ�ȵͱ�є�������Ԉ�(��������������������9�����ѕ�д�ᰁ���е�������̹����������̹م�Օ����(��������������������9����ѕ�е�́ѕ�еͱ�є�������-1">{s.label}</p>
          </div>
        ))}
      </div>
            ...
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input value={currentSubject.name} onChange={e => setCurrentSubject(p => ({ ...p, name: e.target.value }))} className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#0D9488] focus:outline-none" placeholder="홍길동" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select value={currentSubject.site} onChange={e => setCurrentSubject(p => ({ ...p, site: e.target.value }))} className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg">
                    ...
                    <option>서울대병원</option><option>세브뜀스병원</option><option>삼성서울병원</option><option>아산병원</option><option>고려대병원</option>
                  </select>
                </div>
                <div>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl w-[360px] p-6 text-center">
            ...
            <p className="text-sm text-slate-500 mb-5">대상자 {showDeleteConfirm}을(를) 삭제하시겠습니까?<br />이 작업은 되돌릴 수 없습니다.</p>
