...
const initialSubjects: Subject[] = [
  ...
  { id: 'SCR-0167', name: '강도윤', age: 48, gender: '남', site: '세브뜀스병원', status: '부적격', enrollDate: '2024-01-22', phone: '010-7890-1234', diagnosis: '췌장암' },
  { id: 'SCR-0189', name: '윤서연', age: 43, gender: '여', site: '삼성서울병원', status: '등록완료', enrollDate: '2024-01-24', phone: '010-8901-2345', diagnosis: '난솬ȕ�' },
]
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl w-[520px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-end gap-2 p-5 border-t border-slate-100">
              <button onClick={() => setShowModal(false)} className="px-4 py-2 text-sm border border-slate-200 rounded-lg hover:bg-slate-50">ܷ�소</button>
