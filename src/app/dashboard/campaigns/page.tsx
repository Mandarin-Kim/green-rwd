            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">ܺ�페인명</th>
              ...
              <tbody>
                {filteredCampaigns.map((campaign) => (
                  <tr key={campaign.id} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">{formatDate(campaign.startDate)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
