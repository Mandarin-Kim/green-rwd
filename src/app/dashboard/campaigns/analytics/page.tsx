...
export default function CampaignsAnalyticsPage() {
  ...
  const kpiData = [
    ...
    { label: '평균 클릭률', value: `${(totalStats.avgClickRate / count).toFixed(1)}%`, color: 'bg-purple-100', textColor: 'text-purple-700' },
    { label: '평균 전환율', value: `${(totalStats.avgConversionRate / count).toFixed(1)}%`, color: 'bg-orange-100', textColor: 'text-orange-700' },
  ];
